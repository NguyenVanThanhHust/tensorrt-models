...
def create_engine(max_batch_size, builder, config, dt):
    ...
    fc1 = network.add_matrix_multiply(input=pool3.get_output(0),
                                      num_outputs=4096,
    ...
    fc2 = network.add_matrix_multiply(input=relu6.get_output(0),
                                      num_outputs=4096,
    ...
    fc3 = network.add_matrix_multiply(input=relu7.get_output(0),
                                      num_outputs=1000,
